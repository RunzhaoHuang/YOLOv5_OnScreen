...
## Custom Training
If you want to train a custom model to detect other objects, you still have to go through some tricky steps to get it done. Here I will walk you through the training procedure.


#### **Dependencies**
- **Google Colab** notebooks with free GPU: <a href="https://colab.research.google.com/notebooks/intro.ipynb?utm_source=scs-index"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"></a>

- For more information, you need to check the repository [HERE](https://github.com/RunzhaoHuang/YOLOv5_OnScreen/blob/master/yolov5-master/yolov5-custom-training(fish).ipynb). This tutorial is quite detailed and well explained.


#### **P.S.**
-  I didn't dig into the mechanism of Data Labeling here, you can refer to my report in ***Summary Report 11-23-2020***, which has very detailed instructions.
